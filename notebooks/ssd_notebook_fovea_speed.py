  ...
  #for lvar in range(5):
    ...
    if(lvar%10!=0 and ndetectionsinvideo<=6 and areaunderdetections<=0.7):
      if ndetectionsinvideo!=0:
        ...
        rclasses,rscores,rbboxes,_,mfclasses,mfscores,mfbboxes = process_fovea_lowres(img,foveaimg,previousfoveapositions,ndetectionsinvideo,0.5,0.45,(150,150),False,True)
